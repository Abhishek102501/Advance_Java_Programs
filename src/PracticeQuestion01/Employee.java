 ...
 class Solution{
	 public static void main(String[] args) {
		//Sample ArrayList (used in questions)
		 ...
		 Optional<Employee> result1 = empList.stream().max((a , b) ->(int)a.getSalary() - (int)b.getSalary());
		 result1.ifPresent(System.out::println);
		 Optional<Employee> result2 = empList.stream().min((a , b) ->(int)a.getAge() - (int)b.getAge());
		 result2.ifPresent(System.out::println);
		 Optional<Employee> result3 = empList.stream().max((a , b) ->(int)a.getSalary() - (int)b.getSalary());
